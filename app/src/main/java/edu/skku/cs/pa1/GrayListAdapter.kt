...
class GrayListAdapter(val data: ArrayList<letter_unit>,val context: Context): BaseAdapter() {
    fun findGray(inputs: List<String?>){
        for (i: Int in 0..4){
            if(inputs[i+5]=="gray"){
    ...
    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
        ...
        letterView.setBackgroundColor(Color.GRAY)
